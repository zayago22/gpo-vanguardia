...
<head>
    ...
    <title>{{ config('seo.pages.mesa-servicios.title', 'Mesa de Servicios | Grupo Vanguardia') }}</title>
    <meta name="description" content="{{ config('seo.pages.mesa-servicios.meta_description') }}">
    <meta name="keywords" content="{{ config('seo.pages.mesa-servicios.meta_keywords') }}">
    <link rel="icon" href="{{ asset('images/favicon.png') }}" type="image/png">
    @include('partials.seo-head', ['seoPage' => 'mesa-servicios'])
...
<body>
    ...
    <div style="padding-top:79px">
        <section class="page-hero">
            <div class="container">
                <h1>Mesa de Servicios</h1>
                <p>En Grupo Vanguardia contamos con una excelente Mesa de Servicio para atender grandes volúmenes de transacciones telefónicas y gestionarlas a las partes correspondientes de la organización.</p>
            </div>
        </section>
    </div>
    ...
    <section class="section" style="background:var(--gray-50)">
        <div class="container">
            <div class="content-card">
                <p>Es realmente importante contar con una Mesa de Servicio dentro de un Contact Center debido a que es la que responde a incidentes inesperados dentro de la infraestructura tecnológica y los servicios que provee. Tiene la capacidad de respuesta y reacción inmediata, además de que maneja un registro y control de los mismos.</p>
                <p>En Grupo Vanguardia contamos con una excelente Mesa de Servicio para atender grandes volúmenes de transacciones telefónicas y gestionarlas a las partes correspondientes de la organización donde serán atendidos.</p>
                <p>La Mesa de Servicio permite planear, estructurar y proveer la entrega de múltiples actividades. Es un punto central de contacto entre los usuarios y el sitio donde se encuentran las incidencias y peticiones de servicio.</p>
                <p>Además, cuenta con un catálogo de servicios que ayuda a saber qué procesos y qué recursos se necesitan para efectuar una actividad determinada para mejorar la comodidad del usuario.</p>
                <p>La Mesa de Servicio con la que contamos en Grupo Vanguardia da servicio a toda la organización y brinda la mejor atención al cliente.</p>
            </div>
            ...
            <div class="related-nav">
                ...
                <a href="{{ route('mesa-servicios') }}" class="related-btn active"><i class="fas fa-tools"></i>Mesa de Servicios</a>
            </div>
        </div>
    </section>
