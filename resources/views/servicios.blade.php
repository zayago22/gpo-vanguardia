...
<head>
    ...
    <title>{{ config('seo.pages.servicios.title', 'Servicios | Grupo Vanguardia') }}</title>
    <meta name="description" content="{{ config('seo.pages.servicios.meta_description') }}">
    <meta name="keywords" content="{{ config('seo.pages.servicios.meta_keywords') }}">
    <link rel="icon" href="{{ asset('images/favicon.png') }}" type="image/png">
    @include('partials.seo-head', ['seoPage' => 'servicios'])
